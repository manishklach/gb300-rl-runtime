...
| Fixed128 decode path | **Partial** | Real QK / softmax / V math for one fixed-shape path; runtime now routes descriptors through an explicit synthetic query-producer stage and explicit output buffers |
