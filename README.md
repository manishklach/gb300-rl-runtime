...
| Fixed128 decode path | **Partial** | Real QK / softmax / V math for one fixed-shape path; runtime now routes descriptors through explicit model-state and query-projection stages plus explicit output buffers |
